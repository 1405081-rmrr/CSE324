...
<body> 
<h1>       <pre>     <font color="#7D3C98" size="8"  >               <i><u>Turkish Food from Cilantro</u></i></font></h1>
...
$result = mysqli_query($db,"SELECT id,name,price FROM menu where cat_id=7 and res_id=33");
