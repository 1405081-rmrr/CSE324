...
<body> 
<h1>       <pre>     <font color="#7D3C98" size="8"  >               <i><u>Thai Food from Delhi Darbar</u></i></font></h1>
...
$result = mysqli_query($db,"SELECT id,name,price FROM menu where cat_id=5 and res_id=28");
