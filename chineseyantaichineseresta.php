...
<body> 
<h1>       <pre>     <font color="#7D3C98" size="8"  >             <i><u>Chinese Food from Yantai Chinese Resta</u></i></font></h1>
...
$result = mysqli_query($db,"SELECT id,name,price FROM menu where cat_id=3 and res_id=11");
...
?>
<div>
<form method="post"  action="chinesexinxian.php">
  <select name="order">
