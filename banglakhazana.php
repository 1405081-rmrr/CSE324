...
<body> 
<h1>       <pre>     <font color="#7D3C98" size="8"  >               <i><u>Bangla Food from Khazana</u></i></font></h1>
...
$result = mysqli_query($db,"SELECT id,name,price FROM menu where cat_id=1 and res_id=24");
   ...
   <option value="111">111</option>
    <option value="112">112</option>
	 <option value="113">113</option>
	  <option value="114">114</option></select>
