...
<body> 
<h1>       <pre>     <font color="#7D3C98" size="8"  >               <i><u>Bangla Food from Nawabi Voj</u></i></font></h1>
...
$result = mysqli_query($db,"SELECT id,name,price FROM menu where cat_id=1 and res_id=3");
...
<div>
<form method="post"  action="banglanawabivoj.php">
  <select name="order">
