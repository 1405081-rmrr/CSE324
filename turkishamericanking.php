...
<body> 
<h1>       <pre>     <font color="#7D3C98" size="8"  >               <i><u>Turkish Food from American King</u></i></font></h1>
...
$result = mysqli_query($db,"SELECT id,name,price FROM menu where cat_id=7 and res_id=37");
...
<form method="post"  action="banglakhazana.php">
 ...
 <option value="6">6</option>
  ...
  <button type="submit" name="addtocart">Add to Cart</button>
    ...
    <button type="button"  class="button14" style="width:200px;" onclick= "document.location='turkishrestaurant.php'">Back to Restaurant</button>
</form> 
</div>
</body>
</html>
