...
<body> 
<h1>       <pre>     <font color="#7D3C98" size="8"  >                 <i><u>Mughal Food from Sigree</u></i></font></h1>
...
$result = mysqli_query($db,"SELECT id,name,price FROM menu where cat_id=6 and res_id=10");
...
?>
<div>
<form method="post"  action="mughalsigree.php">
 <select name="order">
